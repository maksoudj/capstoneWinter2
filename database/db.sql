...
insert into standards (standard_id, description, context_of_the_standard) values 
("K.1","The student will construct sets of step-by-step instructions (algorithms) either independently or collaboratively including sequencing, emphasizing the beginning, middle, and end. ","At school and at home, students engage in step-by-step activities on a routine basis. These may include such activities as brushing their teeth or preparing to leave school at the end of the school day. When students document these step-by-step instructions they are creating algorithms. As students learn to construct simple algorithms that reflect a daily activity, they realize that the sequences have a beginning, middle, and end. Just as people use algorithms to complete daily routines, they can program computers to use algorithms to complete different tasks. Algorithms are commonly implemented using a precise language that computers can interpret. "),
("K.2","The student will construct programs to accomplish tasks as a means of creative expression using a block-based programming language or unplugged activities, either independently or collaboratively, including sequencing, emphasizing the beginning, middle, and end. ","When an algorithm or a set of algorithms is tested, a program has been created. People work together to plan, create and test these programs. This process of planning, creating, and testing a program or an algorithm is called programming and is used to create a wide variety of products such as video games, interactive art projects, and digital stories. The sequencing of tasks and the testing of programs can be done with or without the use of a computer. When it is done without a computer it is considered an unplugged activity. Unplugged activities allow students to understand the sequencing and testing process in a concrete way. Unplugged activities can be found at sites such as CS Unplugged. Programs can also be developed and tested using computer applications; these are referred to as plugged activities. Students may use block-based programs to sequence steps as they develop simple computer programs.  "),
...
("K.4","The student will categorize a group of items based on one attribute or the action of each item, with or without a computing device. ","Objects and actions have attributes; these attributes allow people to group items. Attributes may be physical properties such as color, shape or form, texture, and size. Actions may be categorized as movement such as those seen in step-by-step sequences (algorithms). Actions may include back and forth movement, turning, and stopping. Categorizing relies on careful observation of patterns and similarities and differences. These similarities and differences can be used to categorize using both unplugged activities and computer devices. "),
("K.5","The student will identify components of computing systems (e.g., keyboard, mouse, desktop computer, laptop computer, tablet, and printer). ","Computing systems are composed of different components. These components enable the user to complete different tasks using a computing system. Common components among desktop and laptop computers, tablets, and mobile phones include a keyboard (either physical or screen based) for inputting information, audio for hearing information, and a screen for viewing information. "),
("K.6","The student will identify, using accurate terminology, simple hardware and software problems that may occur during use (e.g., app or program is not working as expected, no sound is coming from a device, device will not turn on). ","Computing systems might not work as expected because of hardware or software problems. Clearly describing a problem is the first step toward finding a solution. In kindergarten, students are expected to clearly describe a problem in the computing system using developmentally appropriate language. Examples include, “The computer won’t turn on,” “The pointer on the screen won’t move,” or “I lost the web page.” Students are not expected to diagnose or troubleshoot a problem with a computing system in Kindergarten. "),
("K.7","The student will identify what is allowed and what is not allowed at school when using technology. ","Computer networks, including the Internet, can be used to connect people to other people, places, information, and ideas. In order to keep students safe, schools and divisions have rules on the appropriate use of technology. All students should be aware of what is allowed and not allowed when using division/school technology. "),
("K.8","The student will identify personal information (e.g., address, telephone number, and name) and the importance of protecting personal information online. ","Connecting devices to a network or the Internet provides many benefits, but care must be taken to ensure that personal information is not shared with others. Personal information includes a student’s name, address, and phone number. When using a computing system, personal information such as computer passwords are not to be shared with others in the classroom. Students and teachers should never share personal information with anyone on the Internet. Privacy should be considered when posting information online; such information can persist for a long time and be accessed by others, even unintended viewers. "),
...
("1.5","The student will categorize a group of items based on one or two attributes or the actions of each item, with or without a computing device. ","Objects and actions have attributes; these attributes allow people to group items. Attributes may be physical properties such as color, shape, form, texture, and size. Actions may be categorized as movement such as those seen in step-by-step sequences (algorithms). Actions may include back and forth movement, turning, and stopping. Categorizing relies on careful observation of patterns and similarities and differences. These similarities and differences can be used to categorize using both unplugged activities and computer devices. In this standard, students are expected to group items based on one or two attributes or actions. "),
("1.6","The student will acknowledge that materials are created by others (e.g., author, illustrator). ","As students start to work with different artifacts (reference materials, resources, etc.) they should understand that these sources of information were created by others. Authors, illustrators, and programmers are responsible for the creation of many sources of information that we use in our classroom and in our homes. This standard begins an exploration of the concepts of intellectual property laws and plagiarism. Students are not responsible for these terms in first grade. "),
("1.7","The student will identify components of computing systems that are common among different types of computing devices including desktop and laptop computers, tablets, and mobile phones. ","Computing systems are composed of different components. These components enable the user to complete different tasks using a computing system. Common components among desktop and laptop computers, tablets, and mobile devices include a keyboard (either physical or screen-based) for inputting information, audio for hearing information, and a screen for viewing information. "),
("1.8","The student will identify, using accurate terminology, simple hardware and software problems that may occur during use (e.g., app or program is not working as expected, no sound is coming from the device, the device won't turn on). ","Computing systems might not work as expected because of hardware or software problems. Clearly describing a problem is the first step toward finding a solution. Problems with computing systems have different causes, such as hardware settings, programming errors, or faulty connections to other devices. Developmentally appropriate ways to solve problems include debugging simple programs and seeking help by clearly describing a problem (e.g., “The computer won’t turn on,” “The pointer on the screen won’t move,” or “I lost the web page.”). Students are not expected to diagnose or troubleshoot a problem with a computing system in first grade. Students are not expected to differentiate between software and hardware in first grade. "),
("1.9","The student will describe what is allowed and what is not allowed at school associated with the use of technology. ","Computer networks, including the Internet, can be used to connect people to other people, places, information, and ideas. In order to keep students safe, schools and divisions have rules on the appropriate use of technology. All students should be aware of what is allowed and not allowed when using division/school technology. "),
...
("1.11","The student will identify and interpret data and organize it in a chart or graph in order to make a prediction, with or without a computing device. ","The collection and use of data about individuals and the world around them is a routine part of life and influences how people live. Data are pieces of information collected about people or things. These data can be recorded in tables and can be used to construct object graphs or picture graphs. Everyday digital devices can be used to collect and display data over time. Cell phones, digital toys, and cars can contain tools (such as sensors) and computers to collect and display data from their surroundings. Once data has been collected and organized into a chart or graph, it can be analyzed to determine if a pattern exists. The pattern can be used to make predictions or answer questions. "),
("1.12","The student will identify and explain responsible behaviors associated with using information and technology. ","Using computers comes with a level of responsibility, such as not sharing login information, keeping passwords private, and logging off a computer device when finished with a task. These behaviors apply regardless of whether a student is at school or on a computer at another location. In addition to keeping information private, responsible behaviors should be exhibited when engaging in online communications. Online communication facilitates positive interactions, such as sharing ideas with many people, but the public and anonymous nature of online communication also allows for intimidating and inappropriate behavior in the form of cyberbullying. Cyberbullying is a form of bullying that occurs when online communications are sent that are intimidating or threatening in nature. Students are not responsible for the term cyberbullying in first grade "),
("1.13","The student will, in a whole class environment, discuss how information can be communicated electronically (e.g., email, social media). ","Online communication facilitates positive interactions, such as sharing ideas with many people, including friends and family around the world. It also allows opportunities for scientists, mathematicians, business people, and many other professionals to communicate about projects they are working on together. People with similar interests can meet through social media or email and share information; however, the public and anonymous nature of online communication also allows intimidating and inappropriate behavior in the form of cyberbullying. When using social media or email with strangers, do not share personal information such as phone number or address. Pictures should not be shared with unknown parties using digital communication such as social media or email. "),
("2.1","The student will construct sets of step-by-step instructions (algorithms) both independently and collaboratively \na. using sequencing; \nb. using loops (a wide variety of patterns such as repeating patterns or growing patterns); and \nc. identifying events. ","At school and at home, students engage in step-by-step activities on a routine basis. These may include such activities as brushing their teeth or preparing to leave school at the end of the school day. When students document these step-by-step instructions they are creating algorithms. Sometimes there are repeating steps in a task, and students can create a loop in their algorithm to indicate that repeating pattern. Algorithms can be created with or without computers. In first grade the students are introduced to the use of loops, in second grade this understanding expands to include repeating patterns and growing patterns. In second grade, the construction of loops becomes more complex as students use a wide variety of patterns to include repeating and growing patterns. In a repeating pattern the units of the pattern repeat and remain the same. In a growing pattern, an addition is added to the pattern causing the pattern to change every time it repeats. Growing patterns involve a progression from step to step which make them more difficult for students than repeating patterns. Repeating and growing patterns are foundational in mathematics in the development of algebraic reasoning and in computer science in developing computational thinking. Sample numeric patterns include: \n6, 9, 12, 15, 18,....(growing pattern); \n1, 2, 4, 7, 11, 16,….(growing pattern); \n20, 18, 16, 14,…..(growing pattern); and \n1, 3, 5, 1, 3, 5, 1, 3, 5,.....(repeating pattern). \nIn second grade, students are also expected to identify events. In computer science, an event is an action or occurrence detected by a program. Events can be user actions, such as clicking a mouse button or pressing a key, or system occurrences, such as a timer or low battery. "),
("2.2","The student will construct programs to accomplish tasks as a means of creative expression using a block-based programming language or unplugged activities, both independently and collaboratively \na. using sequencing; \nb. using loops (a wide variety of patterns, such as repeating patterns or growing patterns); and \nc. identifying events. ","When an algorithm or a set of algorithms is tested, a program has been created. People work together to plan, create and test these programs. This process of planning, creating, and testing a program or algorithm is called programming and is used to create a wide variety of products such as video games, interactive art projects and digital stories. In second grade, students are expected to develop simple programs that use both sequencing and simple loops to complete a task. These programs may be developed using block-based or unplugged activities. Block-based programs (e.g., Scratch Jr., Tynker) allow students to develop simple algorithms using a computer. Students are also expected to identify events; an event is an action or occurrence detected by a program. "),
("2.3","The student will analyze, correct, and improve (debug) an algorithm that includes sequencing and simple loops, with or without a computing device. ","The practice of reviewing work should be taught early and can be applied across disciplines, including computer science. Students should check that the sequence of steps that compose an algorithm works as intended. That is the only way to determine if the algorithm appropriately reflects the steps that must occur to complete a task. This process can be conducted for both computer programs and unplugged activities. If the algorithm does not work as intended, the students should determine the changes to make in the algorithm in order to complete the task. These changes may include adding, deleting, rearranging, or changing a step in order to obtain the intended outcome. The process of revising a program so that it works as intended is called debugging. "),
...
("2.5","The student will compare and contrast a group of items based on the attributes or actions of each item, with or without a computing device. ","Objects and actions have attributes; these attributes allow people to group items. Attributes may be physical properties, behaviors, or actions. Actions in computer science are reflected in step-by-step sequences (algorithms). Actions may include back and forth movement, turning, and stopping. Categorizing of attributes or actions relies on careful observation of patterns and similarities and differences. In this standard, students are expected to analyze groups of items and compare and contrast the attributes that led to the development of the group. In block-based programming environments, commands are grouped into categories based on function. In higher level programming languages, data are often classified by the type and format of the information. "),
("2.6","The student will acknowledge that materials are created by others (e.g., author, illustrator, and website). ","As students start to work with different artifacts (reference materials, resources, etc.) they should understand that these sources of information were created by others. Authors, illustrators, and programmers are responsible for the creation of many sources of information that are used in the classroom and at home. This standard begins an exploration of the concepts of intellectual property laws and plagiarism. Students are not responsible for the terms property laws and plagiarism in second grade. "),
("2.7","The student will describe the characteristics of computing systems to include hardware, software, input, and output. ","A system is defined as a regularly interacting or interdependent group of items forming a unified whole. A computing system is composed of hardware and software. Hardware consists of physical components, while software provides instructions for the system. These instructions are represented in a form that a computer can understand and allow the user to input information and, once the task is completed, obtain output in a form that can be understood. Hardware and software work together as a system to accomplish tasks, such as sending, receiving, processing, and storing units of information. Hardware devices include screens to display information and buttons, keys, or touch screens to enter information. Software applications are programs with specific purposes, such as a web browser or game. A person may use a mouse (hardware) to click on a button displayed in a web browser (software) to navigate to a new web page. "),
("2.8","The student will identify, using accurate terminology, simple hardware and software problems that may occur during use (e.g., app or program not working as expected, no sound, device won't turn on). ","Although computing systems may vary, common troubleshooting strategies can be used on them, such as checking connections and power or swapping a working part in place of a potentially defective part. Rebooting a machine is commonly effective because it resets the computer. Since computing devices are composed of an interconnected system of hardware and software, troubleshooting strategies may need to address both. Students in second grade are expected to use accurate terminology to describe simple problems with computer hardware and software. "),
("2.9","The student will explain what is allowed and what is not allowed at school associated with the use of technology (e.g., class rules). ","Computer networks, including the Internet, can be used to connect people to other people, places, information, and ideas. In order to keep students safe, schools and divisions have rules on the appropriate use of technology. All students should be aware of what is allowed and not allowed when using division/school technology. Appropriate use of technology as well as school and division rules when using technology should be reviewed with students on a regular basis. Consistent monitoring of students when engaged with technology should be conducted at all times. "),
("2.10","The student will identify and create strong passwords, explain why strong passwords should be used. (e.g., protect name, address, and telephone number). ","Connecting devices to a network or the Internet provides great benefit, but care must be taken to protect private information such as a student’s name, phone number, and address. Passwords are used to protect devices and information from unauthorized access. Because computer programs can be used to guess passwords, strong passwords have characteristics that make them more difficult to guess. Many sites have rules as to the length and composition of passwords; these rules help create stronger passwords. The practice of not sharing passwords should be emphasized in the classroom and at home. At the elementary level, students are encouraged to use passwords. These passwords may not be as complex as those used by adults in protecting information. Suggestions for creating strong passwords for students include: \n1. Use uppercase and lowercase letters. \n2. Use numbers. \n3. Use symbols. \n4. Use at least 8 characters. \n5. Don't use words from a dictionary. \n6. Don't use the same password twice. \n7. Don't use personal information. \nStudents are not expected to list these suggestions; however, these suggestions may be introduced when students are allowed to create or classify passwords. "),
...
("4.4","The student will create a plan as part of the iterative design process, independently and/or collaboratively using a variety of strategies (e.g., pair programming, storyboard, flowchart, pseudocode, story map). ","An iterative design process is a process in which there is repetition of steps of a process in order to generate a sequence of outcomes. Many occupations and content areas use an iterative design process, including computer science and engineering. In computer science, the development of programs uses an iterative process involving design, implementation, and review. The design stage occurs before writing code. The planning stage is when the programmers gather information about the problem and sketch out a solution. This design process may include the use of pseudocode – a process that involves writing out the steps of a program in English to make sure the flow of control and logic make sense. During the implementation stage, the planned design is expressed in a programming language (code) that can be made to run on a computing device. During the review stage, the design and implementation are checked for adherence to program requirements, correctness, and usability. This review could lead to changes in implementation and possibly design, which demonstrates the iterative nature of the process. This standard focuses on the planning portion of the iterative design process. "),
...
("4.6","The student will break down (decompose) a larger problem into smaller sub-problems, both independently and collaboratively. ","When approaching a task it is sometimes easier to break the problem down into manageable chunks. Programs can also be broken down into smaller parts to facilitate their design, implementation, and review; this is referred to as decomposition. Decomposition helps in addressing aspects of program development, such as testing, by allowing people to focus on one piece at a time. Decomposition also enables different people to work on different parts at the same time. An example of decomposition at this level is creating an animation by separating a story into different scenes. For each scene, a background needs to be selected, characters placed, and actions programmed. The instructions required to program each scene may be similar to instructions in other programs. Programs can also be built by adding together smaller components to complete a task. When breaking problems into subproblems, these subproblems should be named or described accurately to allow the programmer to easily reconstruct a program. "),
("4.7","The student will give credit to sources when borrowing or changing ideas (e.g., using information, pictures created by others, using music created by others, remixing programming projects). ","As students start to work with different artifacts (reference materials, resources, etc.) they should understand that these sources of information were created by others. Authors, illustrators, and programmers are responsible for the creation of many sources of information that are used in the classroom and at home. As students choose to use some of these sources in their own work, they are expected to recognize the original creator of the source. This practice should be reiterated throughout a student’s K-12 education and beyond. Ethical complications arise from the opportunities provided by computing. The ease of sending and receiving copies of media on the Internet, such as video, photos, and music, creates the opportunity for unauthorized use, such as online piracy, and disregard of copyrights, such as lack of attribution. Other topics related to copyright are plagiarism, fair use, and properly citing online sources. Knowledge of specific copyright laws is not an expectation at this level. This standard supports English standards as they learn about plagiarism in writing. Students are not responsible for specific copyright laws or using citing practices in fourth grade. "),
("4.8","The student will model how a computing system works including input and output, processors, and sensors. ","A system is defined as a regularly interacting or interdependent group of items forming a unified whole. Computing systems require inputs and outputs. Input and output, also referred to as I/O, is the communication between an information processing system, such as a computer, and the outside world, possibly a human or another information processing system. Inputs are the signals or data received by the system. There is a wide variety of digital collection tools used for gathering and inputting digital data. Tools are chosen based upon the type of measurement they use as well as the type of data people wish to observe. These collection tools include the movements and clicks of your mouse and the keys you type on a keyboard. Sensors are also used in computing systems, such as in robotics, to detect information and serve as input devices for the system. A sensor that is be used with robotic devices is a light sensor that detects changes in brightness. An output is whatever comes out of the system; for example, outputs include data and what can be seen on the computer screen or how the robotic device responds based on the input from the sensor. "),
("4.9","The student will identify, using accurate terminology, simple hardware and software problems that may occur during use, and apply strategies for solving problems (e.g., rebooting the device, checking for power, checking for network availability, closing and reopening an app). ","As with any system, there are times that a computer system does not work as intended. Although computing systems may vary, common troubleshooting strategies can be used on them, such as checking connections and power or swapping a working part in place of a potentially defective part. Rebooting a machine is commonly effective because it resets the computer. Since computing devices are composed of an interconnected system of hardware and software, troubleshooting strategies may need to address both. Students in fourth grade are expected to use accurate terminology to describe simple problems with computer hardware and software. Common troubleshooting strategies, such as checking that power is available, checking that physical and  wireless connections are working, and clearing out the working memory by restarting programs or devices, are effective for many systems.  "),
("4.10","The student will identify and explain problems that relate to inappropriate use of computing devices and networks. ","Computer networks, including the Internet, can be used to connect people to other people, places, information, and ideas. In order to keep students safe, schools and divisions have rules on the appropriate use of technology. As students increase their use of the  networks and interact with others outside of the school or home environment, digital safety is an increasing concern. Students should be aware of what is allowed and not allowed when using division/school technology. Appropriate use of technology as well as school and division rules when using technology should be reviewed with students on a regular basis. Consistent monitoring of students when engaged with technology should be conducted at all times. "),
("4.11","The student will create examples of strong passwords, explain why strong passwords should be used, and demonstrate proper use and protection of personal passwords. ","Connecting devices to a network or the Internet provides great benefit, but care must be taken to protect private information such as a student’s name, phone number, and address. Passwords are used to protect devices and information from unauthorized access. Computer programs can be used to guess passwords; therefore, strong passwords have characteristics that make them more difficult to guess. Many sites have rules as to the length and composition of passwords; these rules help create stronger passwords. The practice of not sharing passwords should be emphasized in the classroom and at home. At the elementary level, students are encouraged to use passwords. These passwords may not be as complex as those used by adults in protecting information. Suggestions for creating strong passwords for students include: \n1. Use uppercase and lowercase letters. \n2. Use numbers. \n3. Use symbols. \n4. Use at least 8 characters. \n5. Don't use words from a dictionary. \n6. Don't use the same password twice. \n7. Don't use personal information. "),
("4.12","The student will use a computer to observe, analyze, and manipulate data in order to draw conclusions and make predictions. ","When answering questions about text in history or English or investigating a question in science, evidence should be used to support your answer. Data are a form of evidence that can be used when answering questions or in making predictions. Data is often sorted or grouped to provide additional clarity. The same data could be manipulated in different ways to emphasize particular aspects or parts of the data set. Computers can be used to obtain, store, and manipulate data. Computers also are used to construct tables and graphs from data collected in class as well as existing data sets that have been compiled by others. The ability to determine what type of data is needed to answer a question and use a computer to find these data are skills needed in many career and academic fields. "),
("4.13","The student will create an artifact using computing systems to model the attributes and behaviors associated with a concept (e.g., solar system). ","Scientists, computer scientists, mathematicians, and programmers construct and use models to better conceptualize and understand phenomena under investigation or to develop a possible solution to a proposed problem. Models include diagrams, physical replicas, mathematical representations, analogies, and computer simulations. Models are used to represent a system (or parts of a system) under study, to aid in the development of questions and explanations, to generate data that can be used to make predictions, and to communicate ideas to others. "),
("4.14","The student will use numeric values to represent non-numeric ideas in the computer (binary, ASCII, pixel attributes such as RGB). ","Computers use numeric values to store information and perform operations. Information inputted into the computer from various components must be converted into numeric values in order for the computer to use the information and perform functions. Once the function is completed, the numeric values must be converted to a form of output that the user can understand. This output may be in the form of words, images, videos, or sounds. Examples of different ways non-numeric information such as letters or colors can be expressed include the use of different protocols such as binary, ASCII, or RGB. Students are not expected to apply these protocols in fourth grade. "),
("4.15","The student will give examples of computing technologies that have changed the world and express how those technologies influence, and are influenced by, cultural practices. ","Societal and cultural problems provide a demand for the development of new technologies. These new computing technologies are created and existing technologies are modified in order to increase their benefits (for example, Internet search recommendations), decrease their risks (for example, autonomous cars), and meet societal demands (for example, smartphone apps). Increased Internet access and speed have allowed people to share cultural information but have also affected the practice of traditional cultural customs. An example of this is that people collaborate and communicate in different ways than they did decades ago. Storytelling and the sharing of information that was conducted between people in a face to face environment now happens virtually much of the time. "),
("4.16","The student will describe the positive and negative impacts of the pervasiveness of computers and computing in daily life (e.g., downloading videos and audio files, electronic appliances, wireless Internet, mobile computing devices, GPS systems, wearable computing). ","The use of technology, including computers, has allowed for global communication and has revolutionized the everyday access of information, whether for business, scientific or personal use. Although there are many positive impacts in using technology, there are also times when computer use has impacted us in undesirable ways. As computer technology continues to advance and new generations of machines grow faster and have greater capabilities, the machines become more deeply fixed in daily life, magnifying both the benefits and the downside risks. Positive impacts include easy access to information, automated machinery, and fast and accurate data processing. Negative impacts include an increase in sedentary lifestyles, family and leisure interruption, and loss of privacy. "),
("4.17","The student will describe social and ethical issues that relate to computing devices and networks. ","People can work in different places and at different times to collaborate and share ideas when they use technologies that reach across the globe. These social interactions affect how local and global groups interact with each other. As with any social interaction, there are manners that people should use when interacting with others. The use of manners when collaborating or interacting with others through computing devices or networks is more complex since many times the communication is done without seeing the person on the other side of the communication. For example, communications should be clear and concise and should never represent the words and actions of others as your own. Care should be taken when sharing information so that the intent of the message is not misunderstood by the person on the other end of the communication. In addition, due to the anonymous nature of online communication, intimidating and inappropriate behavior in the form of cyberbullying may occur. Cyberbullying is a form of bullying that occurs when online communications are sent that are intimidating or threatening in nature.  "),
("4.18","The student will identify and explain different ways information can be transmitted using computing devices via a network (e.g., email, images, and videos). ","Information can be transmitted through both physical and wireless pathways; these pathways are referred to as a network. Network pathways allow communications to occur between computers within the same building or to different locations around the world. These communications exist in a variety of forms to include emails, blogs, images, videos, and through social media platforms. The use of wireless technology allows people to communicate and collaborate, to support work, and to maintain friendships. Students are not expected to know the exact mechanisms for conducting electronic transmissions in fourth grade. "),
("5.1","The student will construct sets of step-by-step instructions (algorithms) both independently and collaboratively, \na. using sequencing; \nb. using loops; \nc. using variables to store and process data; \nd. performing number calculations on variables (addition, subtraction, multiplication and division); and \ne. using conditionals (if-statements). ","Algorithms are commonly used in school and at home as students engage in step-by-step activities that are done on a routine basis. Students can create algorithms as they describe and sequence tasks that are part of daily activities. When an algorithm or a set of algorithms is tested, a program has been created. Programs use sequencing and may include loops and variables; the use of these are dependent on the intended outcome of the program. Students entering fifth grade should have experience with the construction of loops using a wide variety of patterns to include repeating and growing patterns. In fourth grade, students learn that variables are used to store and press data. Variables in a computer program are analogous to 'Buckets' or 'Envelopes' where information can be maintained and referenced. On the outside of the bucket is a name. When referring to the bucket, we use the name of the bucket, not the data stored in the bucket. Many programming languages provide variables, which are used to store, modify, and process data. The data type determines the values and operations that can be performed on that data. Examples of operations that may be used on variables include count and sum. In fifth grade, algorithms become more complex through the addition of conditionals, or “if-statements.” Conditionals act as gates in programs. They test a true-false condition, if it is true then the code inside the gate, or conditional, runs. If the test is false, then the program skips the code and moves on to the next command. Conditionals refer to statements that require the computer to determine whether to run a specific set of instructions based upon certain criteria being met. Conditionals enable the computer to “make a decision” concerning what set of directions to follow. \nTeacher note: the use of the term variable is used across disciplines in fifth grade and students should be aware of how this term can be interpreted or applied differently depending on the discipline context. "),
("5.2","The student will construct programs to accomplish a task as a means of creative expression using a block- or text-based programming language, both independently and collaboratively \na. using sequencing; \nb. using loops; \nc. using variables; \nd. using mathematical operations (addition, subtraction, multiplication and division) variable to manipulate a variable; and \ne. using conditionals (if-statements). ","Computing enables people to use creative development processes to create computational artifacts for creative expression or to solve a problem. Examples of computation artifacts include programs, images, audio, videos, presentations, or web page files. Computing has the potential to provide students’ opportunities to extend their creative expression to solve problems, create computational artifacts, and develop new knowledge. As students create block- and text-based programs, they move from being mere consumers of content to engaging in the subject matter by creating computational artifacts. A computational artifact is anything created by a human using a computer. In fifth grade, students are expected to use block-based or text-based programming to develop basic programs that include sequences, loops, variables, and conditional statements.  "),
("5.3","The student will analyze, correct, and improve (debug) an algorithm that includes sequencing, events, loops, conditionals, and variables. ","In order to determine if an algorithm is an appropriate reflection of the steps that must occur in order to complete a task, the students should review the algorithm and its components to ensure it works as intended. During the review stage, the design and implementation are checked for adherence to program requirements, correctness, and usability. This review could lead to changes in implementation and possibly design, which demonstrates the iterative nature of the process. If the algorithm does not work as intended, the students should determine what changes could be made to the algorithm in order to complete the task. These changes may include adding, deleting, rearranging, or changing a step in order to obtain the intended outcome. The process of revising a program so that it works as intended is called debugging. "),
("5.4","The student will create a plan as part of the iterative design process, both independently and collaboratively using strategies such as pair programming (e.g., storyboard, flowchart, pseudo-code, story map). ","Many occupations and content areas use an iterative design process, including computer science and engineering. In computer science, the development of programs uses an iterative design process involving design, implementation (programming), and review (debugging) until the program runs correctly. The design stage occurs before beginning to program. The planning stage is when the programmers gather information about the problem and sketch out a solution. This design process may include the use of pseudocode - writing out the steps of a program in English to make sure the flow of control and logic make sense. During the implementation stage, the planned design is expressed in a programming language (code) that can be made to run on a computing device. During the review stage, the design and implementation are checked for adherence to program requirements, correctness, and usability. This is the process of debugging discussed in 5.3. This review could lead to changes in implementation and possibly design, which demonstrates the iterative nature of the process. "),
("5.5","The student will break down (decompose) a larger problem into smaller sub-problems, both independently and collaboratively. ","Large programs are often difficult to imagine and create. Large programs can be broken down, or decomposed, into smaller parts in order to facilitate the design, implementation, and review process. These smaller portions of programs are easier to design and implement. They can then be incorporated with other small components to build toward the overall goal. Programs can also be created by incorporating smaller portions of programs that have already been created. Program decomposition also enables different people to work on different parts at the same time. An example of decomposition at this level is creating an animation by separating a story into different scenes. For each scene, a background needs to be selected, characters placed, and actions programmed. The instructions required to program each scene may be similar to instructions in other programs. "),
("5.6","The student will give credit to sources when borrowing or changing ideas (e.g., using information, pictures created by others, using music created by others, remixing programming projects). ","As students start to work with different artifacts (reference materials, resources, etc.) they should understand that these sources of information were created by others. Authors, illustrators, and programmers are responsible for the creation of many sources of information that are used in the classroom and at home. As students choose to use some of these sources in their own work, they are expected to recognize the original creator of the source. This practice should be reiterated throughout a student’s K-12 education and beyond. Ethical complications arise from the opportunities provided by computing. The ease of sending and receiving copies of media on the Internet, such as video, photos, and music, creates the opportunity for unauthorized use, such as online piracy, and disregard of copyrights, such as lack of attribution. Other topics related to copyright are plagiarism, fair use, and properly citing online sources. Knowledge of specific copyright laws is not an expectation at this level. This standard supports English standards as they learn about plagiarism in writing. Students are not responsible for specific copyright laws or using citing practices in fifth grade. "),
("5.7","The student will model how a computing system works including input and output, processors, sensors and storage. ","A system is defined as a regularly interacting or interdependent group of items forming a unified whole. Computing devices are defined as having input, processors, memory and output; these are considered part of a computer system. In computer science, input and output, also referred to as I/O, is the communication between an information processing system, such as a computer, and the outside world, possibly a human or another information processing system. This is how real world information is digitized, or translated in and out of binary. Inputs are the signals or data received by the system. There is a wide variety of digital collection tools used for gathering and inputting digital data. Tools may be chosen based upon the type of data people wish to observe or by the designers of the system. These collection tools include the movements and clicks of your mouse and the keys you type on a keyboard. Sensors are also used in computing systems, such as in robotics, to detect information and serve as input devices for the system. For example, a robotic device depends on sensors, such as a light sensor, to detect changes in brightness. In fifth grade, students are introduced to the concept of storage. Computers store data that can be retrieved later. It is also good practice to save data in multiple locations to protect against loss. The storage capacity of a computing device varies as does the amount of storage required for the saving of different media (pictures, videos, text documents, etc). Data can be stored locally on a hard drive or on the Internet. The connection should be made that variables in programs are how we store and access data when programming. A variable is a name given to a spot in the computer’s memory. The programmer can access and change the data stored in that location by using the variable name. "),
("5.8","The student will identify, using accurate terminology, simple hardware and software problems that may occur during use, and apply strategies for solving problems (e.g., rebooting the device, checking for power, checking network availability, closing and reopening an app). ","As with any system, there are times that a computer system does not work as intended. Although computing systems may vary, common troubleshooting strategies can be used on them, such as checking connections and power or swapping a working part in place of a potentially defective part. Rebooting a machine is commonly effective because it resets the computer. Since computing devices are composed of an interconnected system of hardware and software, troubleshooting strategies may need to address both. Students in fifth grade are expected to use accurate terminology to describe simple problems with computer hardware and software. Common troubleshooting strategies, such as checking that power is available, checking that physical and  wireless connections are working, and clearing out the working memory by restarting programs or devices, are effective for many systems.  "),
("5.9","The student will evaluate and solve problems that relate to inappropriate use of computing devices and networks. ","Computer networks, including the Internet, can be used to connect people to other people, places, information, and ideas. In order to keep students safe, schools and divisions have rules on the appropriate use of technology. As students increase their use of the networks and interact with others outside of the school or home environment, digital safety is an increasing concern. Students should be aware of what is allowed and not allowed when using division/school technology. Appropriate use of technology as well as school and division rules when using technology should be reviewed with students on a regular basis. Consistent monitoring of students when engaged with technology should be conducted at all times. In fifth grade, students should begin to contemplate their role as members of a larger community of technology users and how they will navigate this world ethically and responsibly. "),
("5.10","The student will determine whether passwords are strong, explain why strong passwords should be used, and demonstrate proper use and protection of personal passwords. ","Connecting devices to a network or the Internet provides great benefit, but care must be taken to protect private information such as a student’s name, phone number, and address. Passwords are used to protect devices and information from unauthorized access. Computer programs can be used to guess passwords; therefore, strong passwords have characteristics that make them more difficult to guess. Many sites have rules as to the length and composition of passwords; these rules help create stronger passwords. The practice of not sharing passwords should be emphasized in the classroom and at home. At the elementary level, students are encouraged to use passwords. These passwords may not be as complex as those used by adults in protecting information. Suggestions for creating strong passwords for students include: \na. Use uppercase and lowercase letters. \nb. Use numbers. \nc. Use symbols. \nd. Use at least 8 characters. \ne. Don't use words from a dictionary. \nf. Don't use the same password twice. \ng. Don't use personal information. "),
("5.11","The student will use a computer to observe, analyze, and manipulate data in order to draw conclusions and make predictions. ","When answering questions about text in history or English or investigating a question in science, evidence should be used to support your answer. Data are a form of evidence that can be used when answering questions or in making predictions. Data are often sorted or grouped to provide additional clarity. The same data could be manipulated in different ways to emphasize particular aspects or parts of the data set. Computers can be used to obtain, store, and manipulate data. These data can be used to construct tables and graphs from data collected in class; they can also be sources of existing data sets that have been compiled by others. The ability to determine what type of data is needed to answer a question and use a computer to find these data are skills needed in many career and academic fields. "),
("5.12","The student will create an artifact using computing systems to model the attributes and behaviors associated with a concept (e.g., plate tectonics). ","Scientists, computer scientists, mathematicians, and programmers construct and use models to better conceptualize and understand phenomena under investigation or to develop a possible solution to a proposed problem. Models include diagrams, physical replicas, mathematical representations, analogies, and computer simulations. Models are used to represent a system (or parts of a system) under study, to aid in the development of questions and explanations, to generate data that can be used to make predictions, and to communicate ideas to others. "),
("5.13","The student will use numeric values to represent non-numeric ideas in the computer (e.g., binary, ASCII, pixel attributes such as RGB). ","Similar to humans, computers need a format in which to receive, interpret, and manipulate information. Computers use numeric values to store information and perform operations. Information inputted into the computer from various components must be converted into numeric values in order for the computer to use the information and perform functions. Once the function is completed, the numeric values must be converted to a form of output that the user can understand. This output may be in the form of words, images, videos, or sounds. Examples of different ways non-numeric information such as letters or colors can be expressed include the use of different protocols such as binary, ASCII, or RGB. Students are not expected to apply these protocols in fifth grade. "),
("5.14","The student will give examples and explain how computer science had changed the world and express how computing technologies influence, and are influenced by, cultural practices. ","The needs and wants of different groups of people will have an effect on the types of computing technology they create and use. People tend to use technologies that will help facilitate the various cultural activities they engage in. In turn, the cultural needs of a group will drive development of new and more effective technologies. These new technologies could be to make communication more efficient, facilitate the sharing of ideas, automate common processes, or meet other societal demands. Increased access to the Internet has greatly increased the communication aspect of computing technology, and has also had an effect on the customs of many groups of people. "),
("5.15","The student will evaluate and describe the positive and negative impacts of the pervasiveness of computers and computing in daily life (e.g., downloading videos and audio files, electronic appliances, wireless Internet, mobile computing devices, GPS systems, wearable computing). ","The use of technology, including computers, has allowed for global communication and has revolutionized the everyday access of information, whether for business, scientific or personal use. Although there are many positive impacts in using technology, there are also times when computer use has impacted us in undesirable ways. As computer technology continues to advance and new generations of machines grow faster and have greater capabilities, the machines become more deeply fixed in daily life, magnifying both the benefits and the downside risks. Positive impacts include easy access to information, automated machinery, and fast and accurate data processing. Negative impacts include an increase in sedentary lifestyles, family and leisure interruption, and loss of privacy. "),
("5.16","The student will explain social and ethical issues that relate to computing devices and networks. ","People can work in different places and at different times to collaborate and share ideas when they use technologies that reach across the globe. These social interactions affect how local and global groups interact with each other. As with any social interaction, there are manners that people should use when interacting with others. The use of manners when collaborating or interacting with others through computing devices or networks is more complex since many times the communication is done without seeing the person on the other side of the communication. For example, communications should be clear and concise and should never represent the words and actions of others as your own. Care should be taken when sharing information so that the intent of the message is not misunderstood by the person on the other end of the communication. In addition, due to the anonymous nature of online communication, intimidating and inappropriate behavior in the form of cyberbullying may occur. Cyberbullying is a form of bullying that occurs when online communications are sent that are intimidating or threatening in nature. "),
("5.17","The student will compare and contrast the difference between a local network and a worldwide network. ","A local network is a collection of computers and devices, such as printers, connected together. Many networks in a school or at home are connected using a combination of wired and wireless devices. When a computer connects to a network, it is online. Networks allow computers to share resources, such as hardware, software, data, and information. The sharing of resources saves time and money and also allows different people throughout your house or school to share resources. The Internet is a worldwide collection of networks that connects millions of businesses, government agencies, educational institutions, and individuals. "),
("6.1","The student will construct programs to accomplish a task as a means of creative expression or scientific exploration using a block-based or text-based programming language, both independently and collaboratively, \na. combining control structures such as if-statements and loops; and \nb. creating clearly named variables that represent different data types, including numeric and non-numeric data, and perform operations on their values. ","Programs are collections of code organized in algorithms that can accomplish a variety of tasks. Programs can be developed to perform calculations, manipulate data, or simply to be creative. Programs can involve different control structures such as loops and if-statements; these control structures are blocks of programming that analyze variables within the program code to adjust and use accurate values as they change. Control structures help students develop their problem solving skills and foster computational thinking. Effective variable use, to include the use of identified variables to perform operations, makes the problem solving process easier and faster. One consideration in programming is the flow of control. This refers to the order that commands are run by the computer. The order of the commands, or sequencing, can have dramatic impacts on whether a program runs correctly. By repeating commands the programmer has fewer lines to write, and less opportunities to make mistakes. Conditionals (if-statements) are added to a program to control whether or not commands are run. An if-statement acts as a door. If the condition is true, the door opens and commands connected to the statement are run, otherwise they are skipped. This allows programs to respond to user input and events. In elementary school, students begin their study of programming through a focus on algorithms. They work both collaboratively and individually to develop algorithms to reflect tasks in daily life; these algorithms become more complex as they recognize and use loops and events in the algorithms they construct. Although the use of plugged and unplugged activities is encouraged in early elementary, the expectation is that students use of block- and text-based programming as they progress in elementary years. Middle school continues to build on these skills as students use algorithms to build programs "),
("6.2"," The student will trace programs to predict outcomes and debug (correct and improve) for correctness. ","During the program review stage, the design and implementation are checked for adherence to program requirements, correctness, and usability. This review could lead to changes in implementation and possibly design, which demonstrates the iterative nature of the process. If the program does not work as intended, the students should determine what changes could be made to the program in order to complete the task. These changes may include adding, deleting, rearranging, or changing a step in order to obtain the intended outcome. The process of revising a program so that is works as intended is called debugging. One important skill students need is tracing code. Tracing means reading through commands using paper and pencil and predicting what the code will do. Students practice these skills by reviewing code written by themselves and others. This can be code the teacher creates, or through peer review. "),
("6.3","The student will seek and incorporate feedback from team members and users to refine a program that meets user needs. ","In middle school, students continue to develop effective group work habits across disciplines to help create products on a timetable that reflect all the group members. Programming is frequently done in a group setting. The practice of peer code review in computer science fosters effective communication, and allows students to see a variety of coding styles. The peer review process also allows students to identify common mistakes made by groupmates. A consideration of the peer review process is determining whether the outcome of the program meets the needs of the end-user. Considerations of the end-user may include usability, accessibility, age-appropriate content, respectful language, user perspective, pronoun use, color contrast, and ease of use. "),
("6.4","The student will incorporate existing code, media, and libraries into original programs, and give attribution. ","When developing programs, students are able to use algorithms, code, and other media created by others. The inclusion of existing code or portions of a program into a new program allows students to speed up the development process since they don’t have to create as much from scratch. The scale of imported code can range from small sections of code to large libraries containing entire functionalities. Incorporating and editing the work of others enables students to learn different approaches to writing programs and create more powerful programs. For example, when creating a game, students may incorporate portions of code that create a realistic jump movement from another person's game, and they may also import Creative Commons-licensed images to use in the background. Creative Commons is a set of intellectual property laws that govern the use of media created by others. It is very important that, when using other peoples’ creation, to give attribution to the original author. Students need to cite sources and give credit to the creators for all content they incorporate into their work. "),
("6.5","The student will design projects that combine hardware and software components to collect and exchange data. ","When designing programs or completing projects, students should consider what types of data might be used as input, how the data is to be stored and processed, and the output that meets the specific needs of the user. The collection and exchanging of data is used throughout the programming process. The collection and exchange of data involves input, output, storage, and processing; both software and hardware components are critical to the collection and exchange of data. Student code must be written in a specific way to handle the data’s input and manipulation. These data may be simple text or numbers typed in through the keyboard. There are also data such as motion or sound that may be difficult to enter without specific sensors. Components to collect and exchange data are constantly being developed to meet societal needs. Examples of current components include GPS, car sensors, probeware, smartwatches, and more.  "),
("6.6","The student will identify physical and digital security measures used to protect electronic information. ","Students use passwords to protect access to personal data. The use of passwords and common rules for the construction of passwords was introduced in elementary school. In sixth grade, students extend their knowledge of using passwords to protect data by learning about different types of security measures. They will identify and compare physical and digital security measures and explore the reasons for protecting electronic information. Physical security measures, as the term suggests, include locks on laptops, locked server rooms, etc. Digital security measures include firewalls, encryption, and biometric tests like thumbprint readers or retinal scans, etc. Data protection is also a significant concern when storing and transferring personal and professional data. The concept of data protection extends into a variety of security measures. These security techniques can be hardware or software based. At the middle school level, students are encouraged to use passwords. These passwords may not be as complex as those used by adults in protecting information. Suggestions for creating strong passwords for students include: \na. Use uppercase and lowercase letters. \nb. Use numbers. \nc. Use symbols. \nd. Use at least 8 characters. \ne. Don't use words from a dictionary. \nf. Don't use the same password twice. \ng. Don't use personal information. "),
("6.7","The student will explain how binary sequences are used to represent digital data. Exclusion: Conversions between binary and base-ten numbers are beyond the scope of these standards. ","Similar to humans, computers need a format in which to receive, interpret, and manipulate information. Computers use numeric values to store information and perform operations. Information inputted into the computer from various components must be converted into a binary sequence for processing. This conversion allows the computer to use the information and perform functions. Once all the functions and manipulation are complete, the binary sequence is translated back into a form of output that the user can understand, such as words, images, or sounds. Binary uses a sequence of 1’s and 0’s to represent data; each binary digit is referred to as a bit. All electronic data is binary information. "),
("6.8","The student will use computational tools to collect, organize, and clean data to make it more useful and reliable. ","In order to manipulate data, create representations, and draw conclusions, data must be organized in a consistent fashion. When collecting it is likely that there will be irrelevant and/or erroneous data points in a data set which can distort the results of any analysis. Data scientists spend up to 80% of their time cleaning these irrelevant or erroneous data points. Data cleaning is the process of detecting and correcting (or removing) corrupt or inaccurate records from a record set, table, or database and refers to identifying incomplete, incorrect, inaccurate or irrelevant parts of the data and then replacing, modifying, or deleting the dirty or coarse data. In elementary school students learn that data can be collected and stored in a variety of ways. Students will extend their data collection experience to include computational tools (e.g., surveys, spreadsheets). They will collect data electronically or convert data to an electronic format. The data will be organized and displayed through a graphical representation to make it easy to read and interpret. Removing irrelevant and/or erroneous data points is a new component to data analysis in middle school. "),
("6.9","The student will explain the insight and knowledge gained from digitally processed data by using appropriate visualizations. ","Data visualization is a general term that describes any effort to help people understand the significance of data by placing it in a visual context. Data visualization can allow for insight that would be more difficult than by looking at the raw data. Patterns, trends and correlations that might go undetected in text-based data can be exposed and recognized easier with data visualization models. Visualization model may include: circle graphs, bar graph, line plots, pictographs, Venn Diagram, etc. Software applications can also be used to assist in visualizing data. In sixth grade, students will evaluate visual representations of data to draw conclusions and determine the best visualization for various types of data. This is an opportunity to explore ways that data and graphical representations can be intentionally or unintentionally misleading. "),
("6.10","The student will use models and simulations to formulate, refine, and test hypotheses. ","Models and simulations allow students to represent systems that are too large, too small, or otherwise difficult to study in a classroom setting. Computer models and simulations are necessary when the data sets are too large for human evaluation. There are limitless applications for computer models and simulations. A simulation is a virtual representation of a process that reflects how a real physical situation would most likely happen. Simulations are created using models that were developed based on data. Some examples of simulations are performance of cars in various weather conditions, rocket launches, growth of a population, and the ability of a vaccine to fight a disease. Models are also constructed to test hypotheses. The data generated from the model are used to evaluate whether these models are accurate, make adjustments, and make conclusions. Models and simulations need to be tested for accuracy and refined as necessary. Students entering sixth grade have interpreted and constructed models to explain concepts in both computer science and science. In sixth grade, students will use models to represent systems and simulations to represent processes and to support hypotheses. "),
("6.11","The student will explain how computing has impacted innovations in other fields. ","Almost every industry has been affected by computing technology. Manufacturing, retail, finance, healthcare, and transportation are examples of fields that have been drastically changed by the incorporation of computers. Technologies that have influenced innovation include, but are not limited to: sensors, GPS, digital forensics, cryptocurrency, cybersecurity, databases, the cloud, the Internet, Virtual Reality, 3D printing, self-driving vehicles, etc. Computing has also impacted innovation. Examples of innovation that have affected different career fields include: providing the opportunity for faster production, accessing large quantities of data and information, advancing our ability in communication and collaboration, and self-publishing. In sixth grade, students begin to understand the impact of computer science in multiple career fields. Computer science has provided opportunities for these fields to grow and evolve. "),
("6.12","The student will explore careers related to data. ","There are many options for careers that utilize data collection and analysis. In sixth grade, students will explore various aspects of careers such as work expectations, pay rate, and required education. The use of computer skills is not limited to computer fields; many fields require workers to use computing devices, analyze data, use models and simulations, and use different types of software and hardware when completing tasks. Careers in data science are in high demand. Examples of data-related careers include data analyst, data scientist, data engineer, data architect. \nCurrent information on education, pay, and employment projections can be found through the U.S.Bureau of Labor Statistics (https://www.bls.gov/emp/). "),
("6.13","The student will explain why the speed of data transmission across the Internet can vary depending on the type of data being transmitted. ","Speed of data transmission is how fast data can be sent from one device to another. There are a variety of factors to consider when evaluating transmission speed, including the size of the file or artifact, available bandwidth (maximum rate of data transfer), and concurrent uploading or downloading activity taking place on a given network. Examples of different types of data: jpeg, pdf, Word document, Google Doc, and video. "),
("7.1","The student will construct programs to accomplish a task as a means of creative expression or scientific exploration using a block-based or text-based programming language, both independently and collaboratively, \na. combining control structures such as if-statements and loops including compound conditionals; and \nb. creating clearly named variables that represent different data types, including numeric and non-numeric data, and perform operations on their values. ","Programs are collections of code organized in algorithms that can accomplish a variety of tasks. Programs can be developed to perform calculations, manipulate data, or simply to be creative. Programs can involve different control structures such as loops and if-statements; these control structures are blocks of programming that analyze variables within the program code to adjust and use accurate values as they change. Control structures help students develop their problem solving skills and foster computational thinking. Effective variable use, to include the use of identified variables to perform operations, makes the problem solving process easier and faster. One consideration in programming is the flow of control. This refers to the order that commands are run by the computer. The order of the commands, or sequencing, can have dramatic impacts on whether a program runs correctly. By repeating commands the programmer has fewer lines to write, and less opportunities to make mistakes. Conditionals (if-statements) are added to a program to control whether or not commands are run. An if-statement acts as a door. If the condition is true, the door opens and commands connected to the statement are run, otherwise they are skipped. This allows programs to respond to user input and events. In seventh grade, students should add compound conditionals to their programs. A compound condition specifies a combination of other conditions, allowing for two or more conditions to be tested in a single statement, such as “if-and” and “if-or.” "),
("7.2","The student will document programs to make them easier to follow, test, and debug. ","Proper documentation helps keep track of all aspects of an application and improves on the quality of the program. Documentation allows programmers and reviewers to understand the intention behind a particular portion of code. Documentation comments are formatted to describe portions of the program but are not integrated into the program flow. Often, a programmer will write code and not return to it for lengths of time; documentation can be used to remind them of the intention behind their code and is very useful in debugging, as it signals how the program should be acting. "),
("7.3","The student will distribute tasks and maintain a project timeline when collaboratively developing computational artifacts. ","Development of computational artifacts (program, image, audio, etc.) is often a collaborative effort. Working well in a group requires students to practice strategies such as delegation of responsibility, peer-review, and assigning self-imposed deadlines. These deadlines are used to construct a timeline that informs group participants of responsibilities and expectations when completing a project such as the development of a computational artifact. The creation of appropriate and realistic timelines is difficult to many students, particularly when working in groups. Students may need teacher guidance and scaffolding in the timeline construction process as well as regular reminders to look back and revise timelines as needed throughout the process. "),
("7.4","The student will decompose problems and subproblems into parts to facilitate the design, implementation, and review of programs. ","Decomposition breaks problems down into smaller pieces (subproblems). Problem decomposition allows for complex tasks to be solved in manageable chunks. Once a program has been broken down, it enables different group members to work on different parts at the same time. Decomposition can occur in the planning and design stage, allowing for the separate subprograms to be more easily tackled, or can occur when debugging a long and complex program. Students will practice this skill on programs they wrote and programs written by others. "),
("7.5","The student will describe how the Internet connects devices and networks all over the world. Exclusion: Specific devices used to implement the Internet are beyond the scope of these standards. ","The Internet is a global network of computers. All computer devices (including PCs, laptops, game consoles and smartphones) that are connected to the Internet form part of this network. Some of the computers in this network are called web servers. A web server is a computer which holds websites for other computers linked to the Internet to access. Holding a website is known as ‘hosting’. A web server may host one or many websites and webpages. Sending information to a web server is known as uploading. Receiving information from a web server is known as downloading. "),
("7.6","The student will describe how physical and digital security measures protect electronic information. ","Students will extend their knowledge of the need for physical and digital security measures to understanding and explaining that both types of measures protect our data and personal information. Students can explore different types of security measures and understand how each one protects us in different ways from different types of electronic breaches and attacks. Physical security measures include locking rooms with devices, badges, fingerprints, security cameras, paper shredding, etc. Digital security measures include firewalls, anti-virus software, strong passwords, anti-spyware, etc. In seventh grade, students will take this a step further from sixth grade by describing how these security measures can be applied in a setting. "),
("7.7","The student will identify existing cybersecurity concerns associated with Internet use and Internet-based systems and potential options to address these issues. ","Cybersecurity is a growing industry in the world as more of our personal, financial, government, and military information is transmitted electronically and housed in data centers. Today’s cybersecurity concerns are varied and complex and include actions like breaching of private information from governmental or business sources, the use of ransomware to withhold access to a computing system, or global threats from the hacking of confidential data by hostile entities. Cybersecurity encompasses many aspects of data protection in our society. Some examples are the protection of privacy, military information, credit card and banking information, social media profiles, etc. Measures to prevent loss of data or other cyberthreats, including both physical and digital security measures, must be practiced at all time. These can include logging out of accounts on public computers, use of strong passwords, and those outlined in Standard 7.6. In seventh grade, students will begin to understand how data is vulnerable and what steps are taken to protect it. "),
("7.8","The student will discuss the correctness of a model representing a system by comparing the model’s generated results with data that were observed in the system being modeled. ","Models and simulations allow students to represent systems that are too large, too small, or otherwise difficult to study in a classroom setting. Computer models and simulations are necessary when the data sets are too large for human evaluation. There are limitless applications for computer models and simulations. A simulation is a virtual representation of a process that reflects how a real physical situation would most likely happen. Simulations are created using models that were developed based on data. Some examples of simulations are performance of cars in various weather conditions, rocket launches, growth of a population, and the ability of a vaccine to fight a disease. Models are also constructed to test hypotheses. The data generated from the model are used to evaluate whether the models are accurate, to make adjustments, and draw conclusions. Models and simulations need to be tested for accuracy and refined as necessary. In sixth grade, students used models to represent systems and simulations to represent processes and to support hypotheses. In seventh grade, students will use real-world data to determine if the models and simulations are accurate and adjust the models/simulations to improve accuracy. "),
("7.9","The student will refine computational models based on the data they have generated. ","Models are used in many disciplines to test and isolate specific systems while eliminating some of the complexity that can make results muddy or unclear. Because of this simplification, models need to be tested against real-world data. By designing a model and refining it based upon these data, researchers and designers can gain certainty that the model is valid and its results are meaningful. Students will create and refine computational models to simulate a system. Through this process they will gain insight into how mathematics, science, and computer science are used to understand our world. "),
("7.10","The student will explain how advances in technology have contributed to Virginia’s prosperity and role in the global economy. ","Students will explore a variety of technology fields in which Virginia has acted as a leader. Virginia’s transportation system, which includes highways, railroads, air transportation, and shipping, moves raw materials to factories and finished products to markets. Virginia has a large number of communications and other technology industries. Virginia exports agricultural and manufactured products, including tobacco, poultry, coal, and large ships. Advances in transportation, communications, and technology have facilitated migration and led to economic development in Virginia. The students will investigate these industries’ history, purpose, and how Virginia emerged in a leadership role. "),
("7.11","The student will describe the development of new technologies in communication, entertainment, and business and their impact on American life. ","Since before the Industrial Revolution, advances in technology have been influenced by and have influenced society. As the pace of technological advance increases and becomes more highly specified, these influences can be seen in all aspects of American life - how people interact, how data is stored, the importance of data security, financial transactions, and many more. Students will investigate new and developing technologies. Communication industry technological advancement may include but are not limited to: social media, machine learning, Internet of things, driverless cars, security and privacy, networking, branding, funnel marketing. Business industry technological advancements may include but are not limited to: traceability and safety software, database advancements, customer scheduling, big data and machine learning, automation, and augmented reality. Entertainment industry technological advancement may include but are not limited to: downloading digital music, video streaming, ticket sales, marketing and receiving, licensing, voice technology, and holograms. Students will examine the cause and effect nature between these technologies and various aspects of society, economy, and culture. "),
("7.12","The student will explore careers related to the Internet. ","There are many options for careers that utilize data collection and analysis. Students will explore various aspects of these careers such as type of work, pay rate, and education needed. The use of computer skills is not limited to computer fields; many fields require workers to use computing devices, analyze data, use models and simulations, and use different types of software and hardware when completing tasks. Careers in data science are in high demand; companies are finding it difficult to find workers in this field. Several computer careers are outlined below. \na. A data analyst’s role is to collect, process, and perform statistical data analyses with the goal of helping companies make better business decisions. \nb. A data scientist possesses a combination of analytic, machine learning, data mining, and statistical skills in addition to experience with algorithms and coding. \nc. Data engineers are the designers, builders, and managers of the information or big data infrastructure. \nd. A data architect creates the blueprints for data management systems to integrate, centralize, protect, and maintain data sources. \nCurrent information on education, pay, and employment projections can be found through the U.S.Bureau of Labor Statistics (https://www.bls.gov/emp/). "),
("7.13","The student will outline the advantages and disadvantages of transmitting information over the Internet, including speed, reliability, cost, and security. ","There are a variety of factors to consider when evaluating data transmission over the Internet. Compared to physically sending documents or media, the Internet allows for relatively fast transfer at a low cost. However, sometimes the integrity of a file can be compromised if there is an error in transmission. There is also always a possibility that information can be hacked if it is sent via unsecured channels. Students will explore the different components to sending these messages, such as the medium for data transmission, and make determination of the advantages and disadvantages. "),
("7.14","The student will explain why protocols are necessary in data transmission. Model the role of protocols in transmitting data across networks and the Internet. ","When computers communicate over networks, they break down messages into small chunks called packets. In order to reliably communicate among networked computing devices, all the devices need to create and interpret these packets based on a universally agreed-upon set of rules. Once these rules are in place, no one has to approve a new website or oversee additions to the network. The rules that govern communication among computing devices are called a protocol. Protocols allow computing devices to send and receive messages using the same series of steps for every instance of communication, whether they are sending messages across the room or across the planet. Students are not expected to identify specific rules governing the functionality of transmission protocol in seventh grade. They should describe the overall purpose of a protocol in general terms. "),
("7.15","The student will model how information is broken down into smaller pieces, transmitted as packets through multiple devices over networks and the Internet, and reassembled at the destination. ","Due to the constraints of networks in handling large files, when data in many forms has to be sent, they are broken down into smaller structures of data - called packets - before transmission. Packets are reassembled to the original data chunk once they reach their destination according to the appropriate protocol. This process allows large items to be sent at relatively quick speeds and, due to built in redundancies of packets, also solves problems related to corruption of files occurring at some stage of sending. Students will model how these messages are broken up, transmitted, and put back together to maximize data integrity and efficiency. "),
("8.1","The student will construct programs to accomplish a task as a means of creative expression or scientific exploration using a block-based or text-based programming language, both independently and collaboratively, \na. combining control structures such as if-statements and loops including nested conditionals and loops; \nb. using clearly named variables that represent different data types, including numeric and non-numeric data, and perform operations on their values; and \nc. create functions with parameters. ","Programs are collections of code organized in algorithms that can accomplish a variety of tasks. Programs can be developed to perform calculations, manipulate data, or simply to be creative. Programs can involve different control structures such as loops and if-statements; these control structures are blocks of programming that analyze variables within the program code to adjust and use accurate values as they change. Control structures help students develop their problem solving skills and foster computational thinking. Effective variable use including naming conventions, makes the problem solving process easier and faster. In elementary school, students begin their study of programming through a focus on algorithms. They work both collaboratively and individually to develop algorithms to reflect tasks in daily life; these algorithms become more complex as they recognize and use loops and events in the algorithms they construct. Although the use of plugged and unplugged activities is encouraged in early elementary, the expectation is that students use of block- and text-based programming as they progress in elementary years. In seventh grade, students added compound conditionals to their programs. A compound condition specifies a combination of other conditions, allowing for two or more conditions to be tested in a single statement, such as “if-and” and “if-or.” In eighth grade, students begin to use nested control structures. Placing a structure such as a loop within another loop allows for a greater level of  complexity in the program’s function. These often substitute for what would have been very large sections of repeated code. Functions are named sections of code that allow a programmer to call it from multiple locations and repeat the functionality. Parameters offer an increased level of flexibility in these functions by passing in additional information. "),
("8.2","The student will systematically test and refine programs using a range of test cases. ","As part of the iterative design process, programs should be reviewed and tested to determine if the design goal is met through the generation of specific output. Testing programs using a range of test cases is a necessary step for assessing program correctness. A test case is a single input with an expected output to test the correctness of a program. Programmers need to test a program to make sure it works for all the possible values received as input. This can include values within the range of expected values as well as those outside the given range. Often, programmers will use “edge cases” - parameters that test the extremes of a scenario - to test their programs, ensuring that they will work with even the largest and smallest inputs. In beta test situations programmers use random people to test a program to find “bugs.” Programmers record “versions” of programs as they update and improve their code. "),
("8.3","The student will explain how effective communication between participants is required for successful collaboration when developing programs. ","Because of the highly collaborative nature of programming projects, team members need to employ effective communication strategies. In order to avoid redundant work or gaps in the necessary code, all groups need to have open communication to help standardize the flow of the program. In order to develop a program, tasks can be broken down and created in modules by different groups of students, which requires clear and consistent communication between these groups. Additionally, the peer review fosters effective communication, and helps students see a variety of coding styles as well as identify common mistakes. Program documentation allows for writing that does not affect the flow of a program. This writing is intended to clarify the purpose of a section of code, note a troublesome section for review, or otherwise communicate between group members. In 8th grade, students should be employing these effective communication strategies as well as explain why these techniques are essential for successful programming. "),
("8.4","The student will use flowcharts and/or pseudocode to address complex problems as algorithms. ","In computer science, the development of programs uses an iterative design process involving design, implementation (programming), and review (debugging) until the program runs correctly. The design stage occurs before beginning to program. The planning stage is when the programmers gather information about the problem and sketch out a solution. This design process may include the use of pseudocode - writing out the steps of a program in English to make sure the flow of control and logic make sense. Flowcharts are another tool programmers may use when designing an algorithm or computer program. The flowchart outlines the steps that are needed in the development of an algorithm or program. "),
("8.5","The student will, using the elements of computing devices such as primary memory, secondary storage, processor, input and output devices, and network connectivity, analyze the advantages and limitations of a given computing system. ","Computing devices can have large variation in their functionality, speed, processing ability, data storage capacity, network speed, and other such details. This variability can be related to the hardware components or the choice of software that is being used. These choices are affected by the intended use of a device - a computer that is set up for gaming will have different hardware and software capabilities and limitations than one that is designed for the purposes of data manipulation or architectural renderings. In 8th Grade, students will examine these choices and analyze the pros and cons of different computing systems. "),
("8.6","The student will evaluate physical and digital security measures used to protect electronic information. ","Students will extend their knowledge of the need for physical and digital security measures to understanding and explaining that both types of measures protect our data and personal information. Students can explore different types of security measures and understand how each one protects us in different ways from different types of electronic breaches and attacks. Physical security measures include locking rooms with devices, badges, fingerprints, security cameras, paper shredding, etc. Digital security measures include firewalls, anti-virus software, strong passwords, anti-spyware, etc. In eighth grade, students will analyze the advantages and disadvantages of different physical and digital security systems.  "),
("8.7","The student will identify impacts of hacking, ransomware, scams, fake vulnerability scans, and the ethical and legal concerns involved. Exclusion: Students do not need to implement solutions. ","Students will identify issues and impacts associated with electronic crimes such as hacking, phishing, identity and password theft, ransomware, scams, etc. Hacking is an attempt to exploit a computer system or a private network inside a computer. Ransomware is malicious software that encrypts a computer’s files unless its owner pays a ransom. It is the unauthorized access to or control over computer network security systems for some illicit purpose. This discussion will include the ethical and legal concerns that have arisen as more sensitive data is stored and transmitted electronically. "),
("8.8","The student will \na. explain the difference between a model and a simulation, and \nb. create computational models to conduct simulations. ","Students will understand and explain the difference between a model and a simulation. Modeling means creating a physical replica or equations of a situation or activity. A simulation is a virtual representation of a process that reflects how a real physical situation would most likely happen. Simulations are created using models that were developed based on data. Programmers will create computational models to conduct simulations of familiar systems. Computational models can be created in pseudocode (written) or equations, in block languages (e.g., Scratch), or in text-based languages (e.g., Java, Python). There are also content specific tools for modeling such as MatLab for mathematics. Some examples of computation models might be modeling and simulating a bungee jump, investigating the temperature of melting ice, or investigating the forces and attractions in the states of matter. "),
("8.9","The student will describe tradeoffs between allowing information to be public and keeping information private. ","The Fourth Amendment of the US Constitution protects every American’s right to privacy. However, this amendment was written long before the advent of the Internet, where personal information is easily accessed and, in some cases, exploited. Modern tech companies, such as Facebook, Google, Amazon, and others, mine users’ personal data and online habits to better advertise content and products towards individuals. Students will explore what information they think should be publicly available. Students discuss the benefits and drawbacks to keeping information private when compared to public release. "),
("8.10","The student will evaluate online and print sources for appropriateness and credibility. ","While the Internet has made research much easier than in the past, this access has also allowed for non-vetted and factually inaccurate sources to be presented as equal in validity to more legitimately reviewed and researched outlets. Students will find sources that pertain to a particular topic and evaluate them for inclusion in their work. Students need to assess multiple aspects of a source to test its credibility. Criteria such as those listed in the Currency, Relevancy, Authority, Accuracy, and Purpose (CRAAP) Model should be employed when evaluating online resources. "),
("8.11","The student will discuss the social impacts and ethical considerations associated with the field of cybersecurity. ","Cybersecurity is a growing industry in the world as more of our personal, financial, government, and military information is transmitted electronically and housed in data centers. Today’s cybersecurity concerns are varied and complex and include actions like breaching of private information from governmental or business sources, the use of ransomware to withhold access to a computing system, or global threats from the hacking of confidential data by hostile entities. Cybersecurity encompasses many aspects of data protection in our society. Some examples are the protection of individual privacy, military information, credit card and banking information, and social media profiles. In order to prevent loss of data, identity theft, or other cyberthreats, physical and digital security measures must be practiced at all times. In eighth grade, students will weigh the advantages of cybersecurity in protecting individuals and systems against potential disadvantages of the over-restriction of content and delivery. "),
("8.12","The student will explore careers related to the field of cybersecurity. ","Due to the rise in cybersecurity threats and the increasing value of information and resources that are potentially vulnerable to these threats, the career field in cybersecurity has grown tremendously over the past decades. Examples of these kinds of jobs include security software developer, information security analyst, ethical hacker (white hat), computer forensics analyst, and many others. In eighth grade, Students will explore various aspects of these careers such as work done, pay rate, and education needed. \nCurrent information on education, pay, and employment projections can be found through the U.S.Bureau of Labor Statistics (https://www.bls.gov/emp/). "),
("8.13","The student will identify existing cybersecurity concerns associated with Internet use and Internet-based systems and potential options to address these issues. ","Cybersecurity risks can take many forms and have many consequences. The consequences of hacking can be serious and depend on what level of access the hackers have achieved. Examples of cybersecurity breaches include the theft of social security and credit information from Experian and the hack of Sony Pictures by the North Korean government. Computer viruses (scripts that may be hidden in existing files or programs) and other malware (malicious software installed on a computer) generally have two goals: to propagate from system to system and to perform some action on each system they infect. Similarly, denial-of-service attacks can cripple an online business for long periods of time, which can greatly affect a business’s financials. In eighth grade, students will explore possible risks to the data involved in their use of the Internet. They will also explore the risks and cyber threats for which companies plan and prepare. ");
